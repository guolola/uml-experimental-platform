...
describe("App shell routes", () => {
  ...
  it("does not silently select a provider when the user has not chosen one", async () => {
    projectApiMode = "authenticated";
    window.history.pushState({}, "", "/projects/library-booking");
  ...
  it("clears stale provider settings when the saved provider no longer exists", async () => {
    projectApiMode = "authenticated";
    localStorage.setItem(
      USER_SETTINGS_STORAGE_KEY,
      JSON.stringify({
